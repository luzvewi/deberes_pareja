...
public class pokedex extends JFrame {
	...
	public pokedex() {
		...
		setTitle("pokedex");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//szgshdhr
		...
		lblNewLabel_2.setIcon(new ImageIcon("D:\\imagenes\\borde pokemon.png"));
		...
		lblNewLabel_3.setIcon(new ImageIcon("D:\\imagenes\\imagen_2023-02-22_205004229.png"));
		...
		crear.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				ad.setIcon(new ImageIcon("D:\\imagenes\\charizar.png"));
				ad.setVisible(true);
				toolBar.add(ad);
		...
		crear.setBounds(440, 74, 89, 23);
		ventana.add(crear);
		JButton editar = new JButton("Editar info");
		...
		editar.setIcon(null);
		editar.setBounds(20, 98, 99, 45);
		ventana.add(editar);
		
		JLabel lblUnaVezInsertada = new JLabel("Una vez insertada la información en el boton de \"editar info\" pulse: ");
		lblUnaVezInsertada.setBounds(47, 74, 357, 23);
		ventana.add(lblUnaVezInsertada);
