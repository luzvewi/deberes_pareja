...
public void guardar (int ataque, int ataqueSp, int defensa, int defensaSp, int velocidad) {
	...
	ArrayList<Integer> arraydefensa = new ArrayList<Integer>();
	ArrayList<Integer> arraydefensaSp = new ArrayList<Integer>();
	ArrayList<Integer> arrayvelocidad = new ArrayList<Integer>();
	
	arrayataque.add(ataque);
	arrayataqueSp.add(ataqueSp);
